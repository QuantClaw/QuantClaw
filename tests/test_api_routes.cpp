...
class ApiRoutesReloadTest : public ::testing::Test {
 protected:
  void SetUp() override {
    ...
    quantclaw::web::register_api_routes(
        *http_server_, session_manager_, agent_loop_, prompt_builder_,
        tool_registry_, config_, *gateway_server_, reload_fn_);
