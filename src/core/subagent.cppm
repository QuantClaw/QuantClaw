...
export module quantclaw.core.subagent;
...
// Spawn result
struct SpawnResult {
  enum class Status { kAccepted, kForbidden, kError };
...
struct SubagentRun {
  ...
  enum class State { kRunning, kCompleted, kFailed, kCancelled };
...
struct SubagentConfig {
  ...
  static SubagentConfig FromJsonString(const std::string& json_text);
};
